...
==============================================================================*/
#ifndef TENSORFLOW_LITE_KERNELS_INTERNAL_INTERMITTENT_INTEGER_DEPTHWISE_CONV_H_
#define TENSORFLOW_LITE_KERNELS_INTERNAL_INTERMITTENT_INTEGER_DEPTHWISE_CONV_H_
...
inline void DepthwiseConvPerChannel(
    ...
    int8_t* output_data) {
  printf("Intermittent Depthwise_CONV\n");
  // Get parameters.
...
#endif  // TENSORFLOW_LITE_KERNELS_INTERNAL_INTERMITTENT_INTEGER_DEPTHWISE_CONV_H_
